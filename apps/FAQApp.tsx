...
const FAQApp: React.FC = () => {
    ...
    return (
        <div className="h-full w-full bg-slate-50 flex flex-col font-light">
            {/* Header */}
            <div className="sully-safe-topbar h-20 bg-white/70 backdrop-blur-md flex items-end pb-3 px-4 border-b border-white/40 shrink-0 sticky top-0 z-10">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2 items-start bg-slate-50 p-2 rounded-lg">
                                            <span className="text-xs font-bold text-green-500 shrink-0 mt-0.5">✨ 解决:</span>
