...
const WorldbookApp: React.FC = () => {
    ...
    if (isEditing) {
        return (
            <div className="h-full w-full bg-slate-50 flex flex-col font-sans animate-fade-in">
                <div className="sully-safe-topbar-compact h-16 flex items-center justify-between px-4 bg-white/80 backdrop-blur-md border-b border-slate-200 shrink-0 z-20">
    ...
    return (
        <div className="h-full w-full relative overflow-hidden font-sans bg-slate-100 flex flex-col">
            ...
            {/* Header */}
            <div className="sully-safe-topbar h-20 bg-white/70 backdrop-blur-xl flex items-end pb-3 px-6 border-b border-white/40 shrink-0 sticky top-0 z-20 shadow-sm">
