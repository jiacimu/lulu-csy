        ...
        <div className="h-full w-full bg-slate-50/30 font-light relative">
            {view === 'list' ? (
                <div className="flex flex-col h-full animate-fade-in">
                    ...
                    <div className="sully-safe-overlay-top px-6 pt-16 pb-4 shrink-0 flex items-center justify-between">
                ...
                <div className="flex flex-col h-full animate-fade-in bg-slate-50/50 relative">
                    ...
                    <div className="sully-safe-topbar-spacious h-32 bg-gradient-to-b from-white/90 to-transparent backdrop-blur-sm flex flex-col justify-end px-5 pb-2 shrink-0 z-40 sticky top-0">
