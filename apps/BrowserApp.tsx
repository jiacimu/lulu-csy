...
Generate realistic results linking to hypothetical URLs.`;
    ...
    return (
        <div className="h-full w-full bg-white flex flex-col font-sans relative">
            {/* Top Bar (Address) */}
            <div className="sully-safe-topbar-spacious h-28 bg-slate-50 border-b border-slate-200 flex flex-col justify-end px-4 pb-3 shrink-0 z-20 sticky top-0 shadow-sm">
                {/* Controls Row */}
