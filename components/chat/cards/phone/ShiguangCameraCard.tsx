...
const ShiguangCameraCard: React.FC<ShiguangCameraCardProps> = ({
    ...
    return (
        <div className="sully-card-container sully-phone-card sully-phone-camera-card w-[272px] overflow-hidden rounded-lg border border-[#eadfcc] bg-[#f6efe4] shadow-[0_18px_40px_rgba(67,45,33,0.16)]">
