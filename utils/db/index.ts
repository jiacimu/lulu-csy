...
export const DB = {
    ...
    replaceCollectionWallSnapshot: collectionWallStore.replaceCollectionWallSnapshot,
    ...
    getAllCollectionWallAssets: collectionWallStore.getAllCollectionWallAssets,
    getCollectionWallAssetsByHash: collectionWallStore.getCollectionWallAssetsByHash,
    deleteCollectionWallAsset: collectionWallStore.deleteCollectionWallAsset,
};
