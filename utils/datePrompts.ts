...
▍质量自检（交稿前过一遍）
- 有没有"为了发生而发生"的情节？有就删掉，让它停留。
- 情绪是不是靠形容词直说的？改成动作或环境。
- 对白是不是太工整、句句有用？打碎一点，加废话和停顿。
- 环境描写是不是只当背景板？让光、声音、沉默参与进来。
- 通篇读下来，像不像两个人真的在一个房间里待了一下午？`,
    },
    {
        key: 'sweet',
        label: '心动放大',
...
▍质量自检（交稿前过一遍）
- 关键的那个瞬间，是真的被切短、放慢了，还是一句带过？
- 是不是只聚焦了一个接触点（指尖 / 视线 / 距离）？有没有不小心铺成全景？
- 心思是"没说出口"地渗出来的，还是被直接说穿了？
- 对白有没有那种结巴、改口、假装没说的真实感？
- 读完，会不会让人也跟着屏一下呼吸？`,
    },
    {
        key: 'minimal',
...
▍质量自检（交稿前过一遍）
- 句子够短吗？还有没有能删掉的形容词、副词、定语？
- 是不是用动作在说话，而不是直接写心里在想什么？（动作 : 内心 ≈ 9 : 1）
- 对白短到像真人快聊了吗？有没有哪句"说太满"、该藏起来？
- 留白够不够？最重的那层意思，是不是反而没写、留给读者自己接住？
- 删到不能再删了吗？`,
    },
    {
        key: 'immersive',
...
▍质量自检（交稿前过一遍）
- 句子够不够绵延、跟着情绪呼吸？还是被切得太碎（那是别的档）？
- 感官有没有真的铺开——触感、气味、温度、光的质地，至少落实一两样具体的？
- 情绪是一步步转、带着犹豫和反复的吗？有没有不小心"一句顿悟到位"？
- 有没有写出那种"自己都还没察觉"的细微变化？
- 对白是不是少而准？有没有用太多台词把氛围说破？`,
    },
    {
        key: 'cinematic',
        label: '分镜光影',
...
▍质量自检（交稿前过一遍）
- 每一行是不是都能想象成一个画面（一个镜头）？有没有把几件事挤进一行？
- 镜头之间留了呼吸的间隔吗？还是动作串成了一条？
- 感官是不是偏视听（光、影、声、空气），而没有滑向触觉和心理？
- 环境有没有"动起来"、主动参与？还是只当背景板？
- 推进是靠镜头切换，还是靠硬堆事件？`,
    },
    {
        key: 'desolate',
...
▍质量自检（交稿前过一遍）
- 叙述有没有比当下情绪"清醒半步"？是冷眼旁观，还是跟着角色一起哭、一起燃？
- 情绪是不是被直接命名了？删掉，换成一个物件、一束光、一个动作。
- 比喻取自眼前的日常物件吗（布料 / 镜子 / 灯光 / 颜色 / 旧物）？它戳破了某种心理，还是只是好看的装饰？
- 内心戏冷不冷？有没有滑进自怜自伤？
- 越热闹、越亲密的地方，底下那点凉意和虚无留住了吗？`,
    },
    {
        key: 'restrained',
        label: '机锋暗涌',
...
▍质量自检（交稿前过一遍）
- 每一段铺陈，最后有没有收束到一个真实的情绪或体悟？还是辞藻放完就散了？
- 古典词是"化用"进来、为意象和氛围服务的吗？还是整句搬典故、在掉书袋？
- 意象之间有内在关联和推进（层层叠加）吗？还是只是好看的词硬堆在一起？
- 通感用得准不准（光有温度、声音有形状）？还是为通感而通感？
- 浓，但有没有失控成滥情、矫情？智性这根缰绳还攥在手里吗？
- 所有抒情都长在"你"此刻真实的感知和内心里吗？有没有飘成上帝视角的人生散文？

▍和邻档别混（同样高感官、长句，路子不同）
- 细腻沉浸（普鲁斯特 / 伍尔夫一路）：重心是心理与知觉的绵延流动，感官服务于"情绪一步步转"，不追求辞藻的繁丽。本档则是散文诗式的密丽抒情，意象层叠、古典化用，浓度更高、更"艳"。
- 浮世苍凉：那档几乎不用比喻、冷眼克制；本档恰恰相反，意象通感全放开，是暖的、浓的、缱绻的。`,
    },
    {
        key: 'tender',
        label: '冰雪暖光',
...
▍质量自检（交稿前过一遍）
- 内心是"关系里的感受"吗（在跟某个人的来回里）？还是滑成了孤立的自我抒情？
- 有没有抽象地报情绪（"孤独""失落""难过"）？删掉，让一个具体的小动作、或一句没说出口的话替它说。
- "空隙"写具体了吗——谁先开口、谁没接话、谁多停了一拍、哪句话咽了回去？还是只泛泛说"气氛微妙"？
- 语言够不够透明、干净？有没有忍不住加意象 / 比喻 / 抒情（这档力气在心理精确，不在意象）？
- 暖，但有没有越界去替人物哭、去煽情？
- 最重的意味，是不是落在了沉默和没说完的话里？`,
    },
];
